...
6. Out of scope but flagged (architecture, not domain): `backend/ARCHITECTURE.md` overlaps `docs/docs/architecture/backend.md`, and `backend/docs/api-contract-standard.md` overlaps `docs/docs/architecture/api-contracts.md`. Should these be reduced to pointers to the canonical architecture layer?
