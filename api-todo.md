...
- **בוצע:** הועבר ל-[api-todo-done.md](api-todo-done.md). נשארות בקובץ זה רק החלטות "לא למימוש"/"לא נדרש" (החלטות מוצר).
...
פריטים שהושלמו (✅) הועברו ל-[api-todo-done.md](api-todo-done.md).
