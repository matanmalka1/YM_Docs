...
> פריטים 79–83 הם ממצאי audit UI/UX בפרונט (`/tax/vat/{id}`), לא API gaps.

#### 79. VAT invoice — שני מזהים שונים לאותה שורת חשבונית ✅ בוצע
...
#### 80. VAT invoice edit row — שדה מזהה פנימי נראה editable ✅ בוצע
...
#### 81. VAT invoice row actions menu — toggle לא עקבי + scroll-to-top ✅ בוצע
...
#### 82. VAT status badge — חשד ל-staleness לאחר "אישור קבלת חומרים" ✅ בוצע
...
#### 83. VAT invoice — מחיקת רשומה מ-row menu ללא guard נוסף מעבר ל-confirm ✅ בוצע
