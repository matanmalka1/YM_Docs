...
- Preview/send first load the `ClientRecord`; missing clients raise `CLIENT.NOT_FOUND` (`backend/app/notifications/services/notification_send_service.py:126-128,205-207`).
